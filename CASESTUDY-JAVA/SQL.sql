...
VALUES
    (46, 'Robbery', '2024-04-01', 40.7128, -74.0060, 'Robbery in Vijayawada market, cash stolen, suspect at large.', 'Open', 16, 1),
    (47, 'Homicide', '2024-04-05', 34.0522, -118.2437, 'Homicide in Visakhapatnam, victim identified, suspect arrested.', 'Closed', 17, 2),
    ...
    (51, 'Robbery', '2024-04-25', 33.4484, -112.0740, 'Robbery in Rajahmundry bank, cash and jewelry stolen, suspect on run.', 'Open', 21, 3),
    ...
    (57, 'Homicide', '2024-05-25', 37.7749, -122.4194, 'Homicide in Ongole neighborhood, victim shot, suspect unknown.', 'Open', 27, 4),
    (58, 'Theft', '2024-05-30', 33.4484, -112.0740, 'Theft in Tenali supermarket, stolen goods recovered, suspect apprehended.', 'Closed', 28, 5),
