...
public class VictimsTest {
    ...
    public void testConstructor() {
        ...
        Victims victim1 = new Victims(1, "Jane", "Doe", Date.valueOf("1990-01-01"), Gender.FEMALE, "9876543210", "123 Main St");
        assertEquals((Integer)1, victim1.getVictimID());
        ...
        assertEquals(Gender.FEMALE, victim1.getGender());
    ...
    public void testGettersAndSetters() {
        ...
        assertEquals((Integer)1, victim.getVictimID());
    ...
    public void testHashCode() {
        Victims victim1 = new Victims(1, "Jane", "Doe", Date.valueOf("1990-01-01"), Gender.FEMALE, "9876543210", "123 Main St");
        Victims victim2 = new Victims(1, "Jane", "Doe", Date.valueOf("1990-01-01"), Gender.FEMALE, "9876543210", "123 Main St");
    ...
    public void testEquals() {
        Victims victim1 = new Victims(1, "Jane", "Doe", Date.valueOf("1990-01-01"), Gender.FEMALE, "9876543210", "123 Main St");
        Victims victim2 = new Victims(1, "Jane", "Doe", Date.valueOf("1990-01-01"), Gender.FEMALE, "9876543210", "123 Main St");
        Victims victim3 = new Victims(2, "John", "Smith", Date.valueOf("1995-02-02"), Gender.MALE, "9876543211", "456 Oak St");
    ...
    public void testToString() {
        Victims victim = new Victims(1, "Jane", "Doe", Date.valueOf("1990-01-01"), Gender.FEMALE, "9876543210", "123 Main St");
