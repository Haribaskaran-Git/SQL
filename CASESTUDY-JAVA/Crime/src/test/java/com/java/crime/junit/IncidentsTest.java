...
public class IncidentsTest {
    ...
    public void testConstructor1() {
        ...
        assertEquals((Integer) 1, incident.getIncidentID());
        assertEquals("Theft", incident.getIncidentType());
        assertEquals(Date.valueOf("2023-05-01"), incident.getIncidentDate());
        assertEquals((Double) 37.7749, incident.getLatitude());
        assertEquals((Double) 122.4194, incident.getLongitude());
        assertEquals("Sample description", incident.getDescription());
        assertEquals("Open", incident.getStatus());
        assertEquals((Integer) 30, incident.getVictimID());
        assertEquals((Integer) 15, incident.getSuspectID());
        assertEquals((Integer) 45, incident.getAgencyID());
    }
	...
	public void testGettersAndSetters() {
        ...
        assertEquals("Sample description", incident.getDescription());
        assertEquals("Open", incident.getStatus());
        assertEquals((Integer) 15, incident.getVictimID());
        assertEquals((Integer) 30, incident.getSuspectID());
        assertEquals((Integer) 45, incident.getAgencyID());
	}
	...
	public void testToString() {
		...
		assertEquals(incident.toString(), result);
